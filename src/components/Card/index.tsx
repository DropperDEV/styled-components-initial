...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          <UserPicture src="https://media.licdn.com/dms/image/D4D03AQHgZ9WDYQbKiw/profile-displayphoto-shrink_800_800/0/1699826985397?e=1708560000&v=beta&t=buxKHMmE6Lt-vj3wOSzXnXLiiItmHk5gx45zwGysEPg" />
          <div>
            <h4>James Costa</h4>
            <p> Há 8 minutos</p>
          </div>
        ...
        <PostInfo>
          ...
          <p>
            Projeto feito o curso de html e css no bootcamp dio da Orange Tech+ ... <strong>saiba mais</strong>
          </p>
        </PostInfo>
        <HasInfo>
